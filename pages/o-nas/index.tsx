...
const AboutUs: NextPage<IIndexProps> = ({ images }) => {
  ...
  return (
    <>
      <Layout 
          title='О строительно-отделочной компании ООО "ПоСтрой" | 
          Строительство. Отделка. Проектирование' 
          desc='⭐️ ООО "ПоСтрой" | Строительство. Отделка. Проектирование. 
          Производим строительно-отделочные работы'
          ogTitle='О строительно-отделочной компании ООО "ПоСтрой" | 
          Строительство. Отделка. Проектирование'>
            <WebsiteDev 
              title='О компании ООО "ПоСтрой" | Строительство. 
              Отделка. Проектирование'
              paragraph1='ООО "ПоСтрой" — это одна из ведущих строительно-отделочных компаний 
