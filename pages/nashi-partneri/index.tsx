...
const Partners: NextPage = () => {
  return (
    <Layout 
      title='Партнеры строительно-отделочной компании ООО "ПоСтрой" | 
      Строительство. Отделка. Проектирование.' 
      desc='⭐️ Партнеры строительно-отделочной компании ООО "ПоСтрой" | 
      Строительство. Отделка. Проектирование. ⭐️ Цены снижены! ⭐️ 
      Скидки до 20% ☎️ 8 (908) 787-34-44'
      ogTitle='Партнеры строительно-отделочной компании ООО "ПоСтрой" | 
      Строительство. Отделка. Проектирование.'>
